...
- (NSInteger) maxValueDivide2: (NSArray *)array;
@end
...
- (NSInteger) maxValueDivide2: (NSArray *)array {
    ...
    for (int i = 1; i < numberOfElements; i ++) {
        if (maxValue < [[array objectAtIndex:i] intValue] && [[array objectAtIndex:i] intValue] % 2 == 0) {
...
int main(int argc, const char * argv[]) {
    ...
    NSLog(@"Max number is divided by 2 in array = %ld",[simpleClass maxValueDivide2:array]);
    return 0;
}
